    ...
    <section  class="main">
        ...
        <div id="section_main" class="dashboard">
            <div style="width: 100%; display: flex; align-items: center; justify-content: space-between;">
                <h2 class="dashboard-title">จัดตารางสอบก้าวหน้าบัณฑิตนิพนธ์</h2>
            ...
            <p id="shownone" style="width: 100%; text-align: center; display: none; ">ไม่มีบัณฑิตนิพนธ์สำหรับการจัดสอบก้าวหน้า</p>
        ...
        <div id="section_detail" class="dashboard" style="display: none;">
            <div style="display: flex; align-items: center; margin-bottom: 20px;">
                ...
                <h2 class="dashboard-title" style="margin: 0; margin-bottom: 5px;">รายละเอียดการสอบก้าวหน้าบัณฑิตนิพนธ์</h2>
            </div>
            <p id="shownone2" style="width: 100%; text-align: center; display: none; ">ไม่มีบัณฑิตนิพนธ์การสอบก้าวหน้า</p>
        ...
        <div id="section_view" class="dashboard" style="display: none;">
            <div style="display: flex; align-items: center; margin-bottom: 20px;">
                <i onclick="section_main()" class="fas fa-chevron-left" style="cursor: pointer; font-size: 1.3rem; margin-right: 10px;"></i>
                <h2 class="dashboard-title" style="margin: 0; margin-bottom: 5px;">ผลการสอบก้าวหน้าบัณฑิตนิพนธ์</h2>
            </div>
            <p id="shownone3" style="width: 100%; text-align: center; display: none; ">ไม่มีบัณฑิตนิพนธ์สำหรับผลการสอบก้าวหน้า</p>
        ...
        $.ajax({
            ...
            success: function(response) {
                for(var i=0; i<response.result.length; i++) {
                    if(response.result[i].status2 == "2" && response.result[i].ex_status == "0") {
