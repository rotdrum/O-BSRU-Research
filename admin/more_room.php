    ...
    <section class="main">
        ...
        <div class="dashboard">
            <div class="moretype_title">
                <h2 class="dashboard-title">จัดการห้องสอบ</h2>
                <a href="more_room_add.php" class="btn btn-addtype">
                    เพิ่มห้องสอบ
                </a>
            </div>
            ...
            <div class="table-scroll">
                <table class="table table-research" >
                    ...
                    <?php 
    $count = 1 ;
    $stmt = $pdo->query("select * from selection where type_select = 4 ");
