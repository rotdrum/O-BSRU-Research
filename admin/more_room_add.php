...
<form method="post" action="postmore_add.php" class="main">
        ...
        <div class="dashboard">
        <h2 class="dashboard-title">เพิ่มห้องสอบ</h2>

            <div class="form-control">
                <p>ห้องสอบ</p>
                <input onkeydown="check_select()" required id="txt_type" required type="text" name="data_select" class="txt-input" placeholder="กรอกห้องสอบ">
                <input required type="hidden" name="type_select" value="4">
            ...
            $.ajax({
                ...
                success: function(response) {
                    for(var i=0; i<response.result.length; i++) {
                        if(response.result[i].type_select == "4") {
