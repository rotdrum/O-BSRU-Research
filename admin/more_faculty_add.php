...
<form method="post" action="postmore_add.php" class="main">
        ...
        <div class="dashboard">
            <h2 class="dashboard-title">เพิ่มคณะ</h2>

            <div class="form-control">
                <p>คณะ</p>
                <input onkeydown="check_select()" required id="txt_type" required type="text" name="data_select" class="txt-input" placeholder="กรอกคณะ">
                <input required type="hidden" name="type_select" value="2">
            ...
            $.ajax({
                ...
                success: function(response) {
                    for(var i=0; i<response.result.length; i++) {
                        if(response.result[i].type_select == "2") {
