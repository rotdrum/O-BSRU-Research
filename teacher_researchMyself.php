  ...
  <?php include('teacher_navbarLogin.php'); ?>
    ...
    <div class="txt-header-manage">
        ...
        <div class="report-header">
          <a href="teacher_researchMyself.php?personal_id=<?php echo $_REQUEST['personal_id']; ?>" class="rp-select rp-active">ค้นหาบัณฑิตนิพนธ์</a>
          <a href="teacher_researchApproveMyself.php?personal_id=<?php echo $_REQUEST['personal_id']; ?>" class="rp-select">บัณฑิตนิพนธ์รออนุมัติ</a>
        </div>
      </div>
      <!-- <h3 class="text-header">จัดการบัณฑิตนิพนธ์ (บัณฑิตนิพนธ์ในที่ปรึกษา)</h3> -->
...
-->
    ...
    $stmt = $pdo->query("select * from research where personal_main = ".$_REQUEST['personal_id']." or  personal_sup = ".$_REQUEST['personal_id']."    ");
      ...
      if(($row['status1']==2) || ($row['status2']==2) || ($row['status3']==2) || ($row['status4']==2)  ){
        ?>
                <tr>
                        ...
                        <td>
                      <a href="researchDetail.php?personal_id=<?php echo $_REQUEST['personal_id'] ; ?>&research_id=<?php echo $row['research_id'] ; ?>" style="color: #3498db; text-decoration: underline;"><?php echo $row['name_th'] ; ?></a>
                        </td>
                        <td>
