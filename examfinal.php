...
<?php 
  ...
  <section class="container">
        <div class="txt-header-manage">
            ...
            ?>
                <a href="exam.php?personal_id=<?php echo $_REQUEST['personal_id']; ?>" class="rp-select " style="cursor: pointer;">ก้าวหน้าบัณฑิตนิพนธ์</a>
                <a href="examfinal.php?personal_id=<?php echo $_REQUEST['personal_id']; ?>" class="rp-select rp-active" style="cursor: pointer;">ป้องกันบัณฑิตนิพนธ์</a>
            <?php } else if (isset($_REQUEST['student_id'])) { ?>
                <a href="exam.php?student_id=<?php echo $_REQUEST['student_id']; ?>" class="rp-select " style="cursor: pointer;">ก้าวหน้าบัณฑิตนิพนธ์</a>
                <a href="examfinal.php?student_id=<?php echo $_REQUEST['student_id']; ?>" class="rp-select rp-active" style="cursor: pointer;">ป้องกันบัณฑิตนิพนธ์</a>
            <?php } ?>
            </div>
        </div>
            ...
            for(var i=0; i<list.length; i++) {
                ...
                html += `
                        ...
                        <td>
                            ...
                            <p class="p-td-center">เวลา ${list[i].ex_time2} น.</p>
                        </td>
                        <td>
