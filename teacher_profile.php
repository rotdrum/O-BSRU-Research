...
<html lang="en">
  ...
  <body>
  <?php include('session_personal.php'); ?>
...
?>
    <form action="postteacher_profile.php" method="post" class="container">
      ...
      <div class="card-column">
        ...
        <div class="form-control">
            <p>บัญชีผู้ใช้</p>
            <input type="hidden" name="personal_id" value="<?php echo $row['personal_id'] ; ?>" class="txt-input" placeholder="กรอกบัญชีผู้ใช้">
            <input type="text" name="username" value="<?php echo $row['username'] ; ?>"  class="txt-input" placeholder="กรอกบัญชีผู้ใช้">
        </div>
        <div class="form-control">
            <p>รหัสผ่าน</p>
            <input type="password" name="password" class="txt-input" placeholder="รหัสผ่าน">
        </div>
