...
<?php 
    ...
    <section class="container" id="section_main">
        ...
        <div class="txt-header-manage">
            ...
            <div class="report-header">
                <a href="examapprove.php?personal_id=<?php echo $_REQUEST['personal_id'] ; ?>" class="rp-select ">ก้าวหน้าบัณฑิตนิพนธ์</a>
                <a href="examapprove_final.php?personal_id=<?php echo $_REQUEST['personal_id'] ; ?>" class="rp-select rp-active">ป้องกันบัณฑิตนิพนธ์</a>
                <a onclick="section_view()" class="rp-select" style="cursor: pointer;">รายละเอียดการสอบป้องกัน</a>
            </div>
        </div>
    ...
    <section class="container" id="section_view" style="display: none;">
        ...
        <p id="shownone2" style="display: none; width: 100%; text-align: center;">ไม่มีบัณฑิตนิพนธ์สำหรับผลการสอบป้องกัน</p>
